...
namespace devuino::device
{
	...
	class Resistance
	{
	  public:
		...
		Resistance(const Signal signal, const Power power, const bool debounce = false, const uint8_t iterations = 10, const Resolution bitresolution = Resolution {10}) :
			signal {Potentiometer<Signal> {signal, debounce, iterations, bitresolution}}, power {Switch<Power> {power}} {};
